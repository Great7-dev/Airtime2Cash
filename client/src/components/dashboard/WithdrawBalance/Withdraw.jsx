...
const Withdraw = () => {
  ...
  const handleChange = (selectedOption) => {
    setFormData({
      ...formData,
      accName: selectedOption.bank.accName,
      accNumber: selectedOption.bank.accNumber,
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(res.withdrawalHistory.status);
    if (res && res.withdrawalHistory.status === true) {
      setLoading(false);
      formData.accName = "";
      formData.accNumber = "";
      data.amount = "";
