...
import {CreateAccount, deleteBankAccount, getBankAccount, sellAirtime,withdraw,updateTransactionStatus, cancelTransaction, deleteTransaction,allTransactions,getWithdrawalHistory, getTransactionHistory } from '../controller/accounts';
