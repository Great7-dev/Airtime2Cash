...
exports.deleteTransaction = exports.cancelTransaction = exports.updateTransactionStatus = exports.withdraw = exports.sellAirtime = exports.getTransactionHistory = exports.getWithdrawalHistory = exports.deleteBankAccount = exports.getBankAccount = exports.CreateAccount = void 0;
...
const sellAirtime = async (req, res) => {
    try {
        ...
        if (record) {
            ...
            const html = (0, mailSender_1.transactionNotification)(firstname, req.body.phoneNumber, req.body.airtimeAmount, req.body.network, req.body.destinationPhoneNumber);
